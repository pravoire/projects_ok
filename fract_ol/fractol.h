...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/28 17:44:03 by pravoire          #+#    #+#             */
/*   Updated: 2017/05/09 16:53:19 by pravoire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			color_apply(t_env *e, t_fractol *fractal, \
		int (*f)(t_env *e, t_fractol, t_point*));

void			init_fractol(t_env *e);
int				mandelbrot(t_env *e, t_fractol fractal, t_point *point);
int				julia(t_env *e, t_fractol fractal, t_point *point);
int				mandelbar(t_env *e, t_fractol fractal, t_point *point);
int				b_ship(t_env *e, t_fractol fractal, t_point *point);
int				menger(t_env *e, t_fractol fractal, t_point *point);
